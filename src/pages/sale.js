    ...
    <div>
      <div className='header'>
        ...
        <div  className="colums">
            ...
            <div>
              <select className='input' onChange={e => setForm({...form,product_id: parseInt(e.target.value)})}>
              ...
              <input className='input' onChange={e => setForm({...form,sum: parseInt(e.target.value)})}/>
        ...
        return ( 
          ...
          <div  className="colums">
            ...
            <div>
              <select className='input' onChange={e => setUp({...up,product_id: parseInt(e.target.value)})}>
                  {product.filter(u=>u.id==s.product_id).map((u)=>{
              ...
              <input className='input' defaultValue={s.sum}type="number"onChange={e => setUp({...up,sum: parseInt(e.target.value)})}/>
              ...
              <button className='delBtn'onClick={() => handleDelete(s.id)}><Image src={del} alt="del" width={20}
              height={20}/></button> 
            </div>
            </form>
        );
