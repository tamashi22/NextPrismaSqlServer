        ...
        >
          <div className="colums">
            ...
            <select
              ...
              className="input"
              onChange={(e) =>
                setForm({ ...form, job_title: parseInt(e.target.value) })
              }
            >
              {job.map((j) => {
                return <option value={j.id}>{j.job_title}</option>;
              })}
            </select>
            <input
              className="input"
              type="number"
              onChange={(e) =>
                setForm({ ...form, selery: parseInt(e.target.value) })
              }
            />
            <input
              className="input"
            ...
            <input
              ...
              type="number"
              onChange={(e) =>
                setForm({ ...form, phone_number: parseInt(e.target.value) })
              }
            />
            ...
            >
              <div className="colums">
                ...
                <select
                  className="input"
                  onChange={(e) =>
                    setUp({ ...up, job_title: parseInt(e.target.value) })
                  }
                >
                  {job
                    .filter((j) => j.id == a.job_title)
                    .map((j) => {
                      return (
                ...
                <input
                  className="input"
                  defaultValue={a.selery}
                  type="number"
                  onChange={(e) =>
                    setUp({ ...up, selery: parseInt(e.target.value) })
                  }
                />
                <input
                  className="input"
                  defaultValue={a.adress}
                  type="text"
                  onChange={(e) => setUp({ ...up, adress: e.target.value })}
                />
                <input
                  className="input"
                  ...
                  type="number"
                  onChange={(e) =>
                    setUp({ ...up, phone_number: parseInt(e.target.value) })
                  }
                />
