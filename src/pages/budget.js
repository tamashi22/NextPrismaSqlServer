      ...
      >
        <div className="colums">
          ...
          <input
            ...
            type="number"
            onChange={(e) =>
              setForm({ ...form, budget_amount: parseInt(e.target.value) })
            }
          />
          <input
            className="input"
            type="number"
            onChange={(e) =>
              setForm({ ...form, percent: parseInt(e.target.value) })
            }
          />
          <input
            className="input"
        ...
        return (
          ...
          >
            <div className="colums">
              ...
              <input
                className="input"
                defaultValue={k.budget_amount}
                type="text"
                onChange={(e) =>
                  setUp({ ...up, budget_amount: parseInt(e.target.value) })
                }
              />
              <input
                className="input"
                defaultValue={k.percent}
                type="text"
                onChange={(e) =>
                  setUp({ ...up, percent: parseInt(e.target.value) })
                }
              />
              <input
                className="input"
                defaultValue={k.bonus}
                type="text"
                onChange={(e) =>
                  setUp({ ...up, bonus: parseInt(e.target.value) })
                }
              />
              <button className="btn1" type="submit">
                update
              </button>
              <button className="delBtn" onClick={() => handleDelete(k.id)}>
